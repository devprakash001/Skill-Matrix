...
public final class update_005fquestion_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </nav>\n");
      out.write("\n");
      out.write("    <!-- Update Question Form -->\n");
      out.write("    <div class=\"wrapper\">\n");
      out.write("        <h2>Update Question</h2>\n");
      out.write("        <form action=\"UpdateQuestion\" method=\"post\">\n");
      out.write("            ");
      ...
      out.write("                <input type=\"text\" id=\"question\" name=\"question\" value=\"");
      out.print( db.rst.getString("que") );
      out.write("\" placeholder=\" \" required>\n");
      out.write("                <label for=\"question\">Question:</label>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"input-box\">\n");
      out.write("                <input type=\"text\" id=\"option1\" name=\"option1\" value=\"");
      out.print( db.rst.getString("op1") );
      out.write("\" placeholder=\" \" required>\n");
      out.write("                <label for=\"option1\">Option 1:</label>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"input-box\">\n");
      out.write("                <input type=\"text\" id=\"option2\" name=\"option2\" value=\"");
      out.print( db.rst.getString("op2") );
      out.write("\" placeholder=\" \" required>\n");
      out.write("                <label for=\"option2\">Option 2:</label>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"input-box\">\n");
      out.write("                <input type=\"text\" id=\"option3\" name=\"option3\" value=\"");
      out.print( db.rst.getString("op3") );
      out.write("\" placeholder=\" \" required>\n");
      out.write("                <label for=\"option3\">Option 3:</label>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"input-box\">\n");
      out.write("                <input type=\"text\" id=\"option4\" name=\"option4\" value=\"");
      out.print( db.rst.getString("op4") );
      out.write("\" placeholder=\" \" required>\n");
      out.write("                <label for=\"option4\">Option 4:</label>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"input-box\">\n");
      out.write("                <input type=\"text\" id=\"correctAnswer\" name=\"correctAnswer\" value=\"");
      out.print( db.rst.getString("ans") );
      out.write("\" placeholder=\" \" required>\n");
      out.write("                <label for=\"correctAnswer\">Correct Answer:</label>\n");
      out.write("            </div>\n");
      out.write("            <button type=\"submit\" class=\"submit-btn\">Update Question</button>\n");
      out.write("            <a href=\"AdminHome.jsp\" class=\"cancel-link\">Cancel</a>\n");
      out.write("            ");
